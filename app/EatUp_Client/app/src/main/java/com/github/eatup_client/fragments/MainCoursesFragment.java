...
public class MainCoursesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Log.i("Main Courses", "Create VIEW StartersFragment");
        ...
        productListLiveData = productApiService.getProductsByCategory("Main Courses");
        productListLiveData.observe(getViewLifecycleOwner(), productList -> {
            adapter.setProducts(productList);
            Log.i("Main Courses", "Starters products: " + productList.get(0).getName());
        });
