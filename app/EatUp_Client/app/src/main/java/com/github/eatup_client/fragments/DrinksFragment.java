...
public class DrinksFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Log.i("Drinks", "Create VIEW StartersFragment");
        ...
        productListLiveData = productApiService.getProductsByCategory("Drinks");
        productListLiveData.observe(getViewLifecycleOwner(), productList -> {
            adapter.setProducts(productList);
            Log.i("Drinks", "Starters products: " + productList.get(0).getName());
        });
